...
function setup() {
	...
	ropeObject1= new rope(bobObject1.body,roofObject1.body, -bobDiameter*2,0);
	ropeObject2= new rope(bobObject2.body,roofObject2.body, -bobDiameter*2,0);
	ropeObject3= new rope(bobObject3.body,roofObject3.body, -bobDiameter*2,0);
	ropeObject4= new rope(bobObject4.body,roofObject4.body, -bobDiameter*2,0);
	ropeObject5= new rope(bobObject5.body,roofObject5.body, -bobDiameter*2,0);
	ropeObject6= new rope(bobObject6.body,roofObject6.body, -bobDiameter*2,0);
